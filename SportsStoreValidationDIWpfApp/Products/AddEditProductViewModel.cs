...
namespace SportStoreValidationDIWpfApp.Products
{
    class AddEditProductViewModel : BindableBase
    {
        ...
        public bool EditFlag { get { return _editFlag; } set { SetProperty(ref _editFlag, value); } }
        public SimpleEditableProduct SimpleEditableProduct
        {
            get { return _simpleEditableProduct; }
            set { SetProperty(ref _simpleEditableProduct, value); }
        }
    }
}
